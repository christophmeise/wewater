...
class SuccessPage extends React.Component<Props, any> {
  ...
  render() {
    ...
    return (
      <Layout>
        <SEO
          title={t("SuccessSEOTitle")}
          description={t("SuccessSEODescription")}
        />
        <Container className="global-header-padding">
          ...
          >
            <h3 className={`global-subtitle text-primary`}>
              <Trans>Vielen Dank!</Trans>
            </h3>
            <h2 className="global-headline">
              <Trans>Dein Kauf wurde erfolgreich abgeschlossen</Trans>
            </h2>
          </Header>
          <div className="main-content-sections">
            <section>
              <p>
                <Trans>
                  Danke, dass du dich für WeWater einsetzt. Deine Zahlung war
                  erfolgreich und du erhälst per E-Mail eine Kaufbestätigung.
                </Trans>
              </p>
              <p>
                <Trans>
                  Logge dich in dein PayPal-Konto ein, um die
                  Transaktionsdetails einzusehen.
                </Trans>
              </p>
            </section>
          </div>
