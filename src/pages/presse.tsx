...
class PressePage extends React.Component<Props, any> {
  ...
  render() {
    ...
    return (
      <Layout>
        <SEO
          title={t("PresseSEOTitle")}
          description={t("PresseSEODescription")}
        />
        <HeaderOverlay
          content={<OverlayContent t={t} inverted={true} />}
          darken={true}
          inverted={false}
          sources={headerImage}
          width={16}
            ...
            <Grid columns="2" stackable>
              <GridColumn width="8">
                <section className="presse-section">
                  ...
                  <p>
                    <Trans>
                      Möchtest du mehr über unsere ehrenamtliche Arbeit
                      erfahren? Bist du Medienschaffender und möchtest über uns
                      berichten, brauchst Hintergrundinformationen oder hast
                      einen Projektvorschlag? Hier findest du
                      Kontaktmöglichkeiten, Ansprechpartner, Pressemitteilungen
                      sowie weitere Pressematerialien wie Logos und Fotos.
                    </Trans>
                  </p>
                  <br />
                  <a
                    href="https://www.dropbox.com/sh/hnpshh4sw3x30dq/AACy2I-sBYeIIZi4xv5huEEya?dl=0"
                    target="_blank"
                  >
                    <Button
                      secondary
                  ...
                  <a
                    href="https://www.dropbox.com/sh/nddqbymudy3x7xb/AAAkAePDC9RviQs-kPpPYwU-a?dl=0"
                    target="_blank"
                  >
                    <Button
                      secondary
                ...
                <section>
                  <h2>
                    <Trans>Pressemitteilungen</Trans>
                  </h2>
                  {posts
              ...
              <GridColumn width="8">
                <section className="presse-section">
                  <Grid columns="2" stackable>
                    ...
                    <GridColumn>
                      <h3>
                        <Trans>Ansprechpartner</Trans>
                      </h3>
                      <p>
                        <Trans>Medienanfragen bitte an</Trans>
                      </p>
                ...
                <section>
                  <h2>
                    <Trans>WeWater in den Medien</Trans>
                  </h2>
...
export const pageQuery = graphql`
  query ($language: String!) {
    ...
    blogposts: allWpPost(
      filter: {
        categories: {
          nodes: { elemMatch: { name: { in: ["Presse", "Press"] } } }
        }
    ...
    pageContent: allWpPage(
      filter: {
        title: {
          in: [
            "Pressespiegel – WeWater in den Medien"
            "Press – WeWater in Media"
            "Revue de presse – WeWater dans les médias"
          ]
        }
        language: { slug: { eq: $language } }
      }
