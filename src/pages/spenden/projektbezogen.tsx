...
class SpendenPage extends React.Component<Props, any> {
    ...
    render() {
        ...
        return (
            <Layout>
                <SEO title={t('SpendenProjektSEOTitle')} description={t('SpendenProjektSEODescription')} />
...
const HeaderContent = () => {
    return (
        <div>
            <h1 className="header-overlay-headline"><Trans>Projektbezogen Spenden</Trans></h1>
        </div>
    );
};
