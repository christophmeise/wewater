  ...
  render() {
    ...
    const tableData = [
      ...
      },
      {
        key: t("Filtermenge"),
        value: t(
          "4 Liter Trinkwasser mindestens bei 8 Std. Betriebszeit am Tag"
        ),
      },
      {
        key: t("Innovation"),
    ...
    return (
      <Layout>
        <SEO
          title={t("AqqabagSEOTitle")}
          description={t("AqqabagSEODescription")}
        />
        <VideoOverlay
        ...
        <Container className="global-header-padding">
          ...
          <Grid stackable>
            <GridColumn width={11}>
              <section>
                ...
                <p>
                  <Trans>
                    Die Anwendung ist sehr einfach: Es wird Wasser aus einem See
                    oder einem Fluss mit einer Membran gefiltert. Das Besondere
                    am AQQAbag ist die bisher unerreichte Qualität des Wassers
                    bei gleichzeitig niedrigen Kosten.
                  </Trans>
                </p>
                <p>
                  <Trans>
                    Der AQQAbag verstopft nicht und muss nicht gewartet werden,
                    er ist leicht, handlich und kann unbegrenzt gelagert werden.
                    Damit ist der AQQAbag das ideale Produkt, um Menschen
                    vorübergehend mit Trinkwasser zu versorgen – sei es im
                    Krisenfall, für Menschen, für die noch keine dauerhafte
                    Lösung bereit steht oder für Reisende. Der AQQAbag wurde
                    über mehrere Monate erfolgreich getestet und seine Wirkung
                    von Laboren bestätigt.
                  </Trans>
                </p>
              </section>
            </GridColumn>
          ...
          <section className="global-header-padding">
            <h2>
              <Trans>Der AQQAbag ist u.a. im Einsatz in...</Trans>
            </h2>
      ...
      filter: {
        categories: {
          nodes: {
            elemMatch: {
              name: {
                in: ["AQQAbag-Projekt", "AQQAbag project", "Projet AQQAbag"]
              }
            }
          }
        }
