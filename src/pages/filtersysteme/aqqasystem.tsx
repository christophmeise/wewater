...
class AqqasystemPage extends React.Component<Props, any> {
  ...
  render() {
    ...
    return (
      <Layout>
        <SEO
          title={t("AqqasystemSEOTitle")}
          description={t("AqqasystemSEODescription")}
        />
        <VideoOverlay
          ...
          <Grid stackable>
            <GridColumn width={11}>
              <section>
                ...
                <p>
                  <Trans>
                    Das AQQAsystem basiert auf der Idee des AQQAbag. Es macht in
                    größerem Maßstab aus Oberflächenwasser hygienisch sicheres
                    Trinkwasser. Dabei kann es direkt an eine Wasserquelle oder
                    einen Flußlauf installiert werden.
                  </Trans>
                </p>
                <p>
                  <Trans>
                    Im ersten Reinigungsschritt wird in modularen Boxen, die mit
                    unseren Filterplatten bestückt sind, das Wasser durch die
                    Membran gereinigt. Die Membran besitzt eine Rückhaltewirkung
                    von 99,9999 Prozent für Bakterien. Es wird nur mit
                    geringstem Druck filtriert. Dadurch kann sich der Schmutz
                    nur mit Hilfe der Schwerkraft von der Filterplatte lösen.
                  </Trans>
                </p>
                <p>
                  <Trans>
                    AQQAsystem kann monatelang ohne Reinigung und mit gleich
                    bleibender Leistung genutzt werden und kann durch die
                    Aneinanderreihung mehrerer Boxen für jeden Anwendungsfall
                    konfiguriert werden – von ca. 500 bis 30.000 Litern pro Tag.
                    Unser Filtersystem ist damit eine dauerhafte Lösung zur
                    Trinkwasserversorgung von Dörfern und Gemeinschaften, in
                    denen mehrere Menschen leben.
                  </Trans>
                </p>
              </section>
            </GridColumn>
...
export const pageQuery = graphql`
  query ($language: String!) {
    ...
    aqqasystem1: file(
      relativePath: { eq: "images/filtersysteme/aqqasystem.png" }
    ) {
      childImageSharp {
    ...
    aqqasystem2: file(
      relativePath: { eq: "images/filtersysteme/aqqasystem2.jpg" }
    ) {
      childImageSharp {
        gatsbyImageData(width: 600, quality: 100, layout: CONSTRAINED)
      }
    ...
    projekte: allWpProjekt(sort: { date: DESC }) {
      edges {
        node {
          id
          title
