  ...
  render() {
    ...
    const tableData = [
      ...
      },
      {
        key: t("Kosten"),
        bag: t(
          "41,65 Euro brutto pro Stück (bei kleiner Auflage, ab Auflage von 1.000 Stück sinken die Kosten pro Stück)"
        ),
      ...
      },
      {
        key: t("Haltbarkeit"),
        bag: t(
          "6 Monate im Dauerbetrieb (gelegentlich muss der AQQAbag mit klarem Wasser ausgespült werden)"
        ),
        cube: t(
        ...
        system: t(
          "5 Jahre (halbjährlich muss das AQQAsystem mit klarem Wasser gespült werden)"
        ),
      },
      {
        key: t("Bedienungsanleitung"),
        bag: `<a href="https://wewaterbackend.org/wp-content/uploads/2019/09/anleitung_aqqabag.pdf" target="_blank">Deutsch</a>/
                    <a href="https://wewaterbackend.org/wp-content/uploads/2019/09/aqqabag_instructions.pdf" target="_blank">Englisch</a> (PDF)`,
        cube: `<a href="https://wewaterbackend.org/wp-content/uploads/2020/03/reinigung_aqqacube_DE.pdf" target="_blank">Deutsch</a>/
    ...
    return (
      <Layout>
        <SEO
          title={t("FiltersystemeSEOTitle")}
          description={t("FiltersystemeSEODescription")}
        />
        <VideoOverlay
              ...
              <Grid stackable>
                <GridRow className="team-grid-member" columns="2">
                  <GridColumn width="10">
                    ...
                    >
                      ...
                      <h2 className="global-headline">
                        <Hyphenated language={de}>
                          {t(
                            "Die Lösung für den Soforteinsatz und Einzelpersonen"
                          )}
                        </Hyphenated>
                      </h2>
                    </Header>
                    <p>
                      <Trans>
                        Um kurzfristig den Bedarf an sicherem Wasser zu decken,
                        kann der AQQAbag eine Person ein bis zwei Personen mit
                        mindestens 4 Litern Wasser pro Tag versorgen.
                      </Trans>
                    </p>
                ...
                <GridRow className="team-grid-member" columns="2">
                  <GridColumn width="10">
                    ...
                    <p>
                      <Trans>
                        Der AQQAcube vereint die Vorteile von AQQAbag und
                        AQQAsystem. Mit einem Gewicht von 30kg ist er sehr mobil
                        und filtert mehr als 1000 Liter Wasser in 12 Stunden.
                      </Trans>
                    </p>
                ...
                <GridRow className="team-grid-member" columns="2">
                  <GridColumn width="10">
                    ...
                    <p>
                      <Trans>
                        Das AQQAsystem basiert auf der Idee des AQQAbag, ist
                        jedoch modular skalierbar. So kann er jedem Einsatzort
                        perfekt angepasst werden. Geeignet für Großprojekte.
                      </Trans>
                    </p>
                  ...
                  {tableData.map((row) => {
                    return (
                      <Table.Row key={row.key}>
                        <Table.Cell>
                          <span className="table-cell-key-mobile">
                            <Trans>{row.key}</Trans>
                          </span>
                          <span className="table-cell-key-desktop">
                            <Trans>{row.key}</Trans>
                          </span>
                        </Table.Cell>
                        <Table.Cell>
                          <strong className="table-cell-strong-mobile text-primary">
                            AQQABag
                          </strong>
                          <Trans>
                            <span
                              dangerouslySetInnerHTML={{ __html: row.bag }}
                            ></span>
                          </Trans>
                        </Table.Cell>
                        <Table.Cell>
                          ...
                          <Trans>
                            <span
                              dangerouslySetInnerHTML={{ __html: row.cube }}
                            ></span>
                          </Trans>
                        </Table.Cell>
                        <Table.Cell>
                          ...
                          <Trans>
                            <span
                              dangerouslySetInnerHTML={{ __html: row.system }}
                            ></span>
                          </Trans>
                        </Table.Cell>
                      </Table.Row>
