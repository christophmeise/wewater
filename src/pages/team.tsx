                      ...
                      >
                        {language === "de" && (
                          <h3 className={`global-subtitle text-primary`}>
                            {post?.acf_team?.kurzbeschreibung}
                          </h3>
                        )}
                        {language === "en" && (
                          <h3 className={`global-subtitle text-primary`}>
                            {post?.acf_team?.kurzbeschreibungEnglisch}
                          </h3>
                        )}
                        {language === "fr" && (
                          <h3 className={`global-subtitle text-primary`}>
                            {post?.acf_team?.kurzbeschreibungFr}
                          </h3>
                        )}
                      ...
                      {language === "de" && (
                        <p
                          dangerouslySetInnerHTML={{
                            __html: post.acf_team?.description,
                          }}
                        ></p>
                      )}
                      {language === "en" && (
                        <p
                          dangerouslySetInnerHTML={{
                            __html: post.acf_team?.descriptionEnglisch,
                          }}
                        ></p>
                      )}
                      {language === "fr" && (
                        <p
                          dangerouslySetInnerHTML={{
                            __html: post.acf_team?.descriptionFr,
                          }}
                        ></p>
                      )}
                      <div>
