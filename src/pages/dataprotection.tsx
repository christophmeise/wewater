...
class DataProtection extends React.Component<Props, any> {
  ...
  render() {
    ...
    return (
      <Layout>
        <SEO
          title={t("DataprotectionSEOTitle")}
          description={t("DataprotectionSEODescription")}
        />
        <Container className="global-header-padding">
          ...
          <Container>
            ...
            <p>
              ...
              Geschäftsleitung der WeWater gUG. Eine Nutzung der Internetseiten
              der WeWater gUG ist grundsätzlich ohne jede Angabe
            ...
            <p>
              ...
              WeWater gUG geltenden landesspezifischen Datenschutzbestimmungen.
            ...
            <p>
              Die WeWater gUG hat als für die Verarbeitung Verantwortlicher
            ...
            <p>
              Die Datenschutzerklärung der WeWater gUG beruht auf den
            ...
            <p>Website: www.wewater.org</p>
            <h4>3. Cookies</h4>
            <p>
              Die Internetseiten der WeWater gUG verwenden Cookies. Cookies sind
            ...
            <p>
              Durch den Einsatz von Cookies kann die WeWater gUG den Nutzern
            ...
            <p>
              Die Internetseite der WeWater gUG erfasst mit jedem Aufruf der
            ...
            <p>
              ...
              die WeWater gUG keine Rückschlüsse auf die betroffene Person.
              ...
              anonym erhobenen Daten und Informationen werden durch die WeWater
              gUG daher einerseits statistisch und ferner mit dem Ziel
            ...
            <p>
              ...
              Die von der betroffenen Person eingegebenen personenbezogenen
              Daten werden ausschließlich für die interne Verwendung bei dem für
              die Verarbeitung Verantwortlichen und für eigene Zwecke erhoben
              und gespeichert. Der für die Verarbeitung Verantwortliche kann die
              ...
              Verwendung, die dem für die Verarbeitung Verantwortlichen
            ...
            <p>
              ...
              sind. Ferner berichtigt oder löscht der für die Verarbeitung
            ...
            <p>
              Auf der Internetseite der WeWater gUG wird den Benutzern die
            ...
            <p>
              Die WeWater gUG informiert ihre Kunden und Geschäftspartner in
            ...
            <p>
              Die Newsletter der WeWater gUG enthalten sogenannte Zählpixel. Ein
              ...
              Anhand des eingebetteten Zählpixels kann die WeWater gUG erkennen,
            ...
            <p>
              ...
              des Newsletters deutet die WeWater gUG automatisch als Widerruf.
            </p>
            <h4>8. Kontaktmöglichkeit über die Internetseite</h4>
            <p>
              Die Internetseite der WeWater gUG enthält aufgrund von
            ...
            <p>
              Die WeWater gUG bietet den Nutzern auf einem Blog, der sich auf
            ...
            <ul style={{ listStyle: "none" }}>
              ...
              <li>
                ...
                <p>
                  ...
                  die bei der WeWater gUG gespeichert sind, veranlassen möchte,
                  kann sie sich hierzu jederzeit an einen Mitarbeiter des für
                  die Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der
                  WeWater gUG wird veranlassen, dass dem Löschverlangen
                  unverzüglich nachgekommen wird.
                </p>
                <p>
                  Wurden die personenbezogenen Daten von der WeWater gUG
                  öffentlich gemacht und ist unser Unternehmen als
                  Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der
                  personenbezogenen Daten verpflichtet, so trifft die WeWater
                  gUG unter Berücksichtigung der verfügbaren Technologie und der
                  ...
                  WeWater gUG wird im Einzelfall das Notwendige veranlassen.
                </p>
              </li>
              <li>
                ...
                <p>
                  ...
                  Daten, die bei der WeWater gUG gespeichert sind, verlangen
                  möchte, kann sie sich hierzu jederzeit an einen Mitarbeiter
                  des für die Verarbeitung Verantwortlichen wenden. Der
                  Mitarbeiter der WeWater gUG wird die Einschränkung der
              ...
              <li>
                ...
                <p>
                  Die WeWater gUG verarbeitet die personenbezogenen Daten im
                ...
                <p>
                  Verarbeitet die WeWater gUG personenbezogene Daten, um
                  ...
                  betroffene Person gegenüber der WeWater gUG der Verarbeitung
                  für Zwecke der Direktwerbung, so wird die WeWater gUG die
                ...
                <p>
                  ...
                  WeWater gUG zu wissenschaftlichen oder historischen
                ...
                <p>
                  ...
                  betroffene Person direkt an jeden Mitarbeiter der WeWater gUG
              ...
              <li>
                ...
                <p>
                  ...
                  WeWater gUG angemessene Maßnahmen, um die Rechte und
            ...
            <h4>
              17. Datenschutzbestimmungen zu Einsatz und Verwendung von Jetpack
              für WordPress
            </h4>
            <p>
              Der für die Verarbeitung Verantwortliche hat auf dieser
              Internetseite Jetpack integriert. Jetpack ist ein
              WordPress-Plug-In, welches dem Betreiber einer Internetseite, die
              auf WordPress aufbaut, zusätzliche Funktionen bietet. Jetpack
              gestattet dem Internetseitenbetreiber unter anderem eine Übersicht
              über die Besucher der Seite. Durch die Anzeige von verwandten
              Beiträgen und Publikationen oder die Möglichkeit, Inhalte auf der
              Seite zu teilen, ist ferner die Steigerung der Besucherzahlen
              möglich. Außerdem sind Sicherheitsfunktionen in Jetpack
              integriert, sodass eine Jetpack nutzende Internetseite besser
              gegen Brute-Force-Attacken geschützt ist. Jetpack optimiert und
              beschleunigt ferner das Laden der auf der Internetseite
              integrierten Bilder.
            </p>
            <p>
              Betreibergesellschaft des Jetpack-Plug-Ins für WordPress ist die
              Aut O’Mattic A8C Ireland Ltd., Business Centre, No.1 Lower Mayor
              Street, International Financial Services Centre, Dublin 1,
              Ireland.
            </p>
            <p>
              Jetpack setzt ein Cookie auf dem informationstechnologischen
              System der betroffenen Person. Was Cookies sind, wurde oben
              bereits erläutert. Durch jeden Aufruf einer der Einzelseiten
              dieser Internetseite, die durch den für die Verarbeitung
              Verantwortlichen betrieben wird und auf welcher eine
              Jetpack-Komponente integriert wurde, wird der Internetbrowser auf
              dem informationstechnologischen System der betroffenen Person
              automatisch durch die jeweilige Jetpack-Komponente veranlasst,
              Daten zur Analysezwecken an Automattic zu übermitteln. Im Rahmen
              dieses technischen Verfahrens erhält Automattic Kenntnis über
              Daten, die in der Folge zur Erstellung einer Übersicht der
              Internetseiten-Besuche verwendet werden. Die so gewonnenen Daten
              dienen der Analyse des Verhaltens der betroffenen Person, welche
              auf die Internetseite des für die Verarbeitung Verantwortlichen
              zugegriffen hat und werden mit dem Ziel, die Internetseite zu
              optimieren, ausgewertet. Die über die Jetpack-Komponente erhobenen
              Daten werden nicht ohne eine vorherige Einholung einer gesonderten
              ausdrücklichen Einwilligung der betroffenen Person dazu genutzt,
              die betroffene Person zu identifizieren. Die Daten gelangen ferner
              Quantcast zur Kenntnis. Quantcast nutzt die Daten zu den gleichen
              Zwecken wie Automattic.
            </p>
            <p>
              Die betroffene Person kann die Setzung von Cookies durch unsere
              Internetseite, wie oben bereits dargestellt, jederzeit mittels
              ...
              verhindern und damit der Setzung von Cookies dauerhaft
              widersprechen. Eine solche Einstellung des genutzten
              Internetbrowsers würde auch verhindern, dass Automattic/Quantcast
              ein Cookie auf dem informationstechnologischen System der
              betroffenen Person setzt. Zudem können von Automattic bereits
              gesetzte Cookies jederzeit über den Internetbrowser oder andere
              Softwareprogramme gelöscht werden.
            </p>
            <p>
              Ferner besteht für die betroffene Person die Möglichkeit, einer
              ...
              dieser Internetseite bezogenen Daten sowie der Verarbeitung dieser
              Daten durch Automattic/Quantcast zu widersprechen und eine solche
              zu verhindern. Hierzu muss die betroffene Person den
              Opt-Out-Button unter dem Link https://www.quantcast.com/opt-out/
              drücken, der einen Opt-Out-Cookie setzt. Der mit dem Widerspruch
              gesetzte Opt-Out-Cookie wird auf dem von der betroffenen Person
              genutzten informationstechnologischen System abgelegt. Werden die
              Cookies auf dem System der betroffenen Person nach einem
              Widerspruch gelöscht, muss die betroffene Person den Link erneut
            ...
            <p>
              ...
              wenn ein Nutzer kein PayPal-Konto unterhält. Ein PayPal-Konto wird
              über eine E-Mail-Adresse geführt, weshalb es keine klassische
              Kontonummer gibt. PayPal ermöglicht es, Online-Zahlungen an Dritte
              auszulösen oder auch Zahlungen zu empfangen. PayPal übernimmt
            ...
            <p>
              ...
              Mit der Auswahl dieser Zahlungsoption willigt die betroffene
              Person in die zur Zahlungsabwicklung erforderliche Übermittlung
            ...
            <p>
              ...
              IP-Adresse, Telefonnummer, Mobiltelefonnummer oder andere Daten,
              die zur Zahlungsabwicklung notwendig sind. Zur Abwicklung des
              Kaufvertrages notwendig sind auch solche personenbezogenen Daten,
            ...
            <p>
              ...
              weiter, soweit dies zur Erfüllung der vertraglichen
            ...
            <p>
              ...
              DS-GVO beruhen.
              <br /> Letztlich könnten Verarbeitungsvorgänge auf Art. 6 I lit. f
            ...
            <h4>
              24. Berechtigte Interessen an der Verarbeitung, die von dem
            ...
            <h4>
              26. Gesetzliche oder vertragliche Vorschriften zur Bereitstellung
            ...
            <p>
              ...
              <br /> Mitunter kann es zu einem Vertragsschluss erforderlich
              ...
              <br /> Vor einer Bereitstellung personenbezogener Daten durch den
