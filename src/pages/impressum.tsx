...
class Impressum extends React.Component<Props, any> {
  ...
  render() {
    ...
    return (
      <Layout>
        <SEO
          title={t("ImpressumSEOTitle")}
          description={t("ImpressumSEODescription")}
        />
          ...
          <Container text>
            <div className="main-content-sections">
              <section>
                ...
                <p>
                  “http://www.shutterstock.de” “http://www.flickr.de”
                  “http://www.pixelio.de” “https://unsplash.com” Hannes
                  Schwessinger, Thilo Kunz, Steven Hille, Ulrich Weise Insofern
                  hier nicht angegeben wird die Quelle unter dem Bild genannt.
                  Quelle Impressum: eRecht24 Quelle Icons AQQABag, AQQACube,
                  AQQASystem: Biedermann und Brandstift
                </p>
              </section>
            </div>
          </Container>
...
const HeaderContent = (t) => {
  return (
    <div>
      <h1 className="header-overlay-headline">
        {t("page_impressum:headline")}
      </h1>
      <h2 className="header-overlay-subheadline">
        {t("page_impressum:subheadline")}
      </h2>
    </div>
  );
};
