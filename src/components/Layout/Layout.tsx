...
class Layout extends Component<Props, any> {
  ...
  handleScroll() {
    ...
    var percentage = (body[top] / (body[height] - rootNode.clientHeight)) * 100;
  ...
  onHoverMenuItem = (section) => {
    ...
    backgroundEl.style.transform = `
            translateX(${
              this.state[section].x - this.state[section].navwidth / 2
            }px)
    ...
    contentEl.style.transform = `translateX(${
      this.state[section].x - this.state[section].navwidth / 2
    }px)`;
  };
          ...
          <main role="main" ref={this.myRef}>
            ...
            >
              ...
              <div>
                ...
                <p>
                  <Trans>
                    Our website uses cookies to analyze how the site is used and
                    to ensure your experience is consistent between visits.{" "}
                    <Link to={"/dataprotection"}>Cookies Policy</Link>
                  </Trans>
                </p>
              </div>
            </CookieConsent>
            ...
            <li className="navlist-primary-entry">
              <Link to={"/filtersystem"} language={language}>
                <div className="navlist-menu-entry">
                  <h4>
                    <Trans>Alle Filtersysteme</Trans>{" "}
                    <Icon
                      className="icon-filtersysteme"
                      icon={arrowSmallRight}
                      color="#5ABEE6"
                    />
                  </h4>
                  <p>
                    <Trans>Übersicht aller Entwicklungen</Trans>
                  </p>
                </div>
              </Link>
            </li>
              ...
              <Link to={"/filtersysteme/aqqabag"} language={language}>
                <div className="navlist-circle">
                  <svg
                    ...
                    className="custom-drawn"
                    fill="#FFFFFF"
                  >
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M2947 5879 c-25 -15 -32 -30 -180 -415 -147 -379 -158 -425 -137
...
132 -330z"
                    ...
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M3133 5062 c-7 -4 -16 -28 -22 -52 -11 -51 -58 -100 -94 -100 -62 0
...
-16 24 -57 32 -82 16z"
                    ...
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M3725 5506 c-69 -38 -85 -62 -85 -130 0 -45 3 -51 48 -92 26 -24 64
...
-10 98 -14 27 -106 80 -138 80 -15 0 -54 -15 -87 -34z"
                    ...
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M1822 4925 c-40 -13 -80 -29 -88 -36 -10 -8 -14 -35 -14 -95 l0 -85
...
43 -57 87 -74 71 -115 99 -145 98 -12 -1 -56 -11 -96 -24z"
                    ...
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M3607 4414 c-94 -47 -112 -61 -138 -102 -49 -77 -41 -95 69 -169 51
...
-42 72 -26 16 -66 5 -170 -48z"
                    ...
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M1133 3824 c-15 -24 -15 -29 -2 -53 14 -24 20 -26 97 -29 l82 -3 0
...
0 130 0 130 270 0 270 0 0 -130z"
                    ...
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M3107 272 c-13 -14 -17 -39 -17 -104 0 -93 13 -118 61 -118 42 0 49
17 49 120 0 61 -4 100 -12 108 -18 18 -63 14 -81 -6z"
                ...
                <div className="navlist-menu-entry">
                  <h4>AQQAbag</h4>
                  <p>
                    <Trans>Lösung für Einzelpersonen</Trans>
                  </p>
                </div>
              </Link>
            </li>
              ...
              <Link to={"/filtersysteme/aqqacube"} language={language}>
                <div className="navlist-circle">
                  <svg
                    ...
                    width="100%"
                    height="100%"
                    viewBox="0 0 6420 6420"
                    preserveAspectRatio="xMidYMid meet"
                    className="custom-drawn"
                    fill="#FFFFFF"
                  >
                    <path
                      d="M4938 6345 c-180 -44 -350 -182 -433 -350 -51 -103 -69 -183 -69
...
337 197 520 150z"
                    />
                    <path
                      d="M5010 6060 c-19 -19 -20 -33 -20 -223 l0 -202 128 -128 c138 -137
165 -152 197 -103 23 35 9 59 -109 176 l-106 105 0 187 c0 175 -1 188 -19 198
-29 15 -49 12 -71 -10z"
                    />
                    <path
                      d="M974 5701 c-100 -24 -190 -98 -235 -195 l-29 -62 2 -2575 3 -2574 27
...
338 477 337 477 1321 0 1320 -1 328 -465z"
                    />
                    <path
                      d="M1962 4158 c-9 -9 -12 -312 -12 -1304 0 -1413 -4 -1317 57 -1317 56
1 53 -67 53 1313 0 1138 -2 1278 -16 1298 -17 24 -62 30 -82 10z"
                    />
                    <path
                      d="M2336 4154 c-14 -14 -16 -146 -16 -1303 0 -1405 -4 -1314 55 -1314
59 0 55 -91 55 1313 0 1234 -1 1288 -18 1303 -23 21 -56 22 -76 1z"
                    />
                    <path
                      d="M2706 4154 c-14 -14 -16 -146 -16 -1303 0 -1405 -4 -1314 55 -1314
59 0 55 -91 55 1314 0 1407 4 1319 -55 1319 -13 0 -31 -7 -39 -16z"
                    />
                    <path
                      d="M3077 4152 c-16 -17 -17 -122 -17 -1298 0 -1385 -3 -1316 53 -1316
61 -1 57 -97 57 1318 0 1268 0 1293 -19 1304 -29 15 -56 12 -74 -8z"
                    />
                    <path
                      d="M3445 4147 c-14 -21 -15 -167 -13 -1305 2 -838 6 -1284 13 -1290 25
-24 55 -23 80 2 l25 25 0 1273 c0 1137 -2 1276 -16 1296 -21 30 -69 30 -89 -1z"
                    />
                    <path
                      d="M3822 4158 c-9 -9 -12 -312 -12 -1304 0 -1413 -4 -1317 57 -1317 56
1 53 -67 53 1313 0 1138 -2 1278 -16 1298 -17 24 -62 30 -82 10z"
                    />
                    <path
                      d="M2865 5390 c-185 -33 -275 -167 -196 -292 22 -34 44 -53 88 -74 53
...
-98 55 -98 75 0 24 44 65 85 80 53 19 157 19 202 0z"
                ...
                <div className="navlist-menu-entry">
                  <h4>AQQAcube</h4>
                  <p>
                    <Trans>Sofortlösung für Lebensgemeinschaften</Trans>
                  </p>
                </div>
              </Link>
            </li>
              ...
              <Link to={"/filtersysteme/aqqasystem"} language={language}>
                <div className="navlist-circle">
                  <svg
                    ...
                    width="100%"
                    height="100%"
                    viewBox="224.02 185.85 218.62 294.96"
                    preserveAspectRatio="xMinYMin meet"
                    className="custom-drawn-small"
                    fill="#FFFFFF"
                  >
                    <g
                      id="g10"
                ...
                <div className="navlist-menu-entry">
                  <h4>AQQAsystem</h4>
                  <p>
                    <Trans>Lösung für den langfristigen Einsatz</Trans>
                  </p>
                </div>
              </Link>
            </li>
            <li className="navlist-primary-entry">
              <Link to={"/filtersysteme/tutorials"} language={language}>
                <div className="navlist-menu-entry">
                  ...
                  <p>
                    <Trans>Wir erklären unsere Lösungen</Trans>
                  </p>
                </div>
              </Link>
            </li>
