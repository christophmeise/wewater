                    ...
                    <GridColumn width="10">
                        <div className="embed-wrap rounded shadow">
                            <iframe
                                ...
                                srcDoc="<style>*{padding:0;margin:0;overflow:hidden}html,body{height:100%}img,span{position:absolute;width:100%;top:0;bottom:0;margin:auto}span{height:1.5em;text-align:center;font:48px/1.5 sans-serif;color:white;text-shadow:0 0 0.5em black}</style><a href=https://www.youtube.com/embed/zy1MzATrJkc?autoplay=1><img src=images/video_placeholder.webp alt='WeWater Team Video'><span>▶</span></a>"
                                frameBorder="0"
