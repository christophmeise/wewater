    ...
    return (
      ...
      >
        {(addComment) => (
          ...
          >
            <h3>
              <Trans>Hinterlasse eine Nachricht</Trans>
            </h3>
            <p>
              <Trans>
                Deine Email wird nicht veröffentlicht. Notwendige Felder sind
                markiert *
              </Trans>
            </p>
            <FormGroup>
            ...
            <FormGroup inline className="dsgvo-checkbox-wrapper-wrapper">
              <FormField inline className="dsgvo-checkbox-wrapper">
                <input
                  ...
                  name="dsgvo"
                  type="checkbox"
                  value={this.state.dsgvo}
                  onChange={this.handleInputChange}
                ></input>
                <label htmlFor="dsgvo">
                  <Trans>
                    Mit der Nutzung dieses Formulars erklären Sie sich mit der
                    Speicherung und Verarbeitung Ihrer Daten durch diese Website
                    einverstanden. Weitere Informationen erfahren Sie in der{" "}
  ...
  render() {
    ...
    switch (this.state.commentStatus) {
      case "success":
        return (
          <p>
            <Trans>Dein Kommentar wurde erfolgreich gespeichert.</Trans>
          </p>
        );
      case "loading":
        return (
          <p>
            <Trans>Dein Kommentar wird abgeschickt...</Trans>
          </p>
        );
      case "error":
        return (
          <p>
            <Trans>
              Dein Kommentar konnte leider nicht gespeichert werden, probiere es
              später bitte noch einmal
            </Trans>
          </p>
        );
      default:
